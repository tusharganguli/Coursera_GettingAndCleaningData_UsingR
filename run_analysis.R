...
setwd("F:/online courses/coursera/DataScience-JohnHopkins/3 - Getting and Cleaning Data/project/getdata%2Fprojectfiles%2FUCI HAR Dataset/UCI HAR Dataset/")             
...
mean_and_std <- cbind(subject,activity_labels,mean_values,std_values)
colnames(mean_and_std)[1] <- "Subject"
colnames(mean_and_std)[2] <- "Activity"
rm(subject,activity_labels,feature_vector, mean_values,std_values)
